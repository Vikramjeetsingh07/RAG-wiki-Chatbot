...
Six real experiments — every screenshot captured from the live system.

---

### 01 · Document Summarization

> **Structured synthesis from a 200-page novel**

Drops *Pride and Prejudice* into the system — retrieves the most relevant chunks and synthesises a structured summary with Key Events, Characters, and Themes.

![Document Summarization](screenshots/01-document-summarization.png)

---

### 02 · Factual Retrieval from Research Papers

> **Precision extraction from dense academic text**

Asked "What problem does RAG solve?" across multiple loaded papers. The system locates the exact answer inside a 15-page academic PDF, showing `RAG_Research_paper.pdf` at 69% relevance with source attribution. Consistent across multiple query phrasings.

![Factual Retrieval — Source Citation](screenshots/02-factual-retrieval-source.png)

![Factual Retrieval — Detailed Breakdown](screenshots/02-factual-retrieval-detailed.png)

![Factual Retrieval — Full Response](screenshots/02-factual-retrieval-full.png)

---

### 03 · Benchmark Result Extraction

> **Precise numerical data from results tables**

Extracts all 8 benchmark datasets and exact Natural Questions scores (RAG-Sequence 44.5 EM, RAG-Token 44.1 EM) from a dense results table buried on page 5 of the paper.

![Benchmark Datasets](screenshots/03-benchmark-datasets.png)

![Benchmark Extraction](screenshots/03-benchmark-extraction.png)

---

### 04 · Cross-Document Synthesis

> **Multi-hop reasoning across two separate papers**

Retrieves from **both** `transformers_paper.pdf` (74%) and `RAG_Research_paper.pdf` (73%) simultaneously, synthesising a coherent explanation of how Transformer self-attention underpins RAG's generator.

![Cross-Document Synthesis](screenshots/04-cross-document-synthesis.png)

---

### 05 · Personal Resume Q&A

> **Your own career history as a queryable knowledge base**

Queries resume + research paper simultaneously. Identifies RBC enterprise RAG experience (68%) cross-referenced with the RAG paper (53%). First query with no name returns honest failure — second with full name succeeds.

![Resume Q&A — Honest Failure → Precise Success](screenshots/05-resume-qa.png)

![Resume Q&A — Multi-Source](screenshots/05-resume-qa-multi.png)

---

### 06 · Conversational Memory + Anti-Hallucination

> **Multi-turn context and honest knowledge boundaries**

Follow-up questions correctly resolve pronoun references from chat history. 4 sources cited at 74–85% relevance. Cosine vs neural retriever comparison synthesised across documents.

![Conversational Memory — Retriever Comparison](screenshots/06-conversational-memory.png)

![Retrieval Comparison — WikiMind vs RAG Paper](screenshots/06-retrieval-comparison.png)

![Embedding Model + Cosine Similarity Justified](screenshots/06-embedding-cosine.png)

When asked about the FIFA World Cup (not in any loaded document), the system correctly responds: *"The provided context does not contain this information."*

![Anti-Hallucination — FIFA → "not in context"](screenshots/06-anti-hallucination.png)
